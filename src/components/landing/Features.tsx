...
const scienceFeatures: FeatureItem[] = [
  { icon: <Lightbulb size={24} />, title: "Your body cannot sustain maximum fear.", text: "Understanding this reduces the fear of fear itself." },
  { icon: <Wind size={24} />, title: "Slow, deep breathing directly activates the vagus nerve, ", text: "triggering a physiological calm response." },
  { icon: <KanjiIcon />, title: "Purposeful physical activity — like calligraphy — ", text: "interrupts rumination and restores present-moment awareness." },
];
...
export const FeaturesScience = () => (
  <FeatureSplit
    ...
    heading="The science behind breathing and grounding"
    intro="Every feature in Calmisu is grounded in established neuroscience and evidence-based self-regulation techniques."
