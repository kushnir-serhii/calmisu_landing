...
export const PrivacyEn = () => (
  <LegalDoc>
    ...
    <LegalText>
      The Application uses Artificial Intelligence (AI) technology to power
      its chat feature. Your chat messages are processed by OpenAI to
      generate responses. Please refer to{" "}
      <ExternalLink href="https://openai.com/policies/privacy-policy">
        OpenAI's Privacy Policy
      </ExternalLink>{" "}
      for details on how your data is handled during AI processing.
    </LegalText>
    <LegalText>
    ...
    <LegalText>
      ...
      identifiable information. The information collected and retained
      includes:
    </LegalText>
    <LegalList>
      <li>Account information: name, email address</li>
      <li>Subscription information: purchase token, next payment date</li>
      <li>Device tokens: push notification token</li>
      <li>Analytics: usage data via Firebase Analytics and Google Analytics</li>
    </LegalList>
    <LegalText>
    ...
    <LegalHeading>Calm Profile Quiz (Website)</LegalHeading>
    <LegalText>
    ...
    <LegalText>
      ...
      Chat messages entered by the user are processed by OpenAI in their
      original form solely to generate AI responses; they are not sold or
    ...
    <LegalText>
      You can opt out of analytics data collection at any time through the
      app's privacy settings, without uninstalling the Application. You can
      also stop all data collection by uninstalling the Application using
      the standard uninstall processes available on your mobile device or
      via the mobile application marketplace.
    </LegalText>

    <LegalHeading>Data Retention Policy</LegalHeading>
    <LegalText>
    ...
    <LegalText>This privacy policy is effective as of 2026-09-22</LegalText>
